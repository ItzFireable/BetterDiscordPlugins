  ...
  const config = {
    ...
    info: {
      ...
      authors: [
        {
          name: 'kimi',
          discord_id: '329152844261490689',
          github_username: 'ItzFireable',
          twitter_username: ''
        }
      ],
      version: '0.0.1',
      description: "owoifys every text on your discord client, you're welcome.",
      github: 'https://github.com/ItzFireable',
      github_raw: 'https://raw.githubusercontent.com/ItzFireable/BetterDiscordPlugins/master/owoify.plugin.js'
    },
    changelog: [
      {
        title: 'first version',
